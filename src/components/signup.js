      ...
      <ThemeProvider theme={theme}>
        <div className={classes.paper} dir="rtl">       
          <Grid container spacing={0} maxWidth="xs" >
            ...
            <div style={{ position: 'absolute', background: 'rgba(0,0,0,0.2)', color: '#fff', width: '100%', height: '9%',  transform: "translate(-50%, -50%)", left: '50%', bottom: 0, textAlign: "center", margin: 0, top: 900,}}>
                <p style={{  fontSize: '90%',}}>Rose Mark © 2020</p>
            </div> 
          </Grid>
